...
| **Backplane Power Path** | LM74700 + IRFS7530, 40 A blade fuse, SMCJ33CA | Backplane | Ideal-diode reverse-polarity protection at the DC input (XT60 connector), fused at 40 A (ATO blade fuse in a PCB-mount holder), TVS-clamped (§8.4). The fuse's 32 V DC rating and the clamp's 33 V stand-off set the bus ceiling. |
