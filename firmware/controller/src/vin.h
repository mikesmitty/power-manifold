...
// 3.3 V full scale reads 42.9 V and the SMCJ33A clamp on the bus (~36.7 V)
...
// The chassis is specified for 20-28 V; the backplane's 5 V rail drops out
// near 18 V. Flags come with half a volt of hysteresis so a sagging supply
// does not flap the problem indicator.
...
// "24.13 V", "18.70 V LOW", "29.40 V HIGH", "no sample yet", "not fitted"
