...
| **A2** | **VIN** | **PGND** | **B2** | Main DC input power rail (24V nominal, 20V–28V declared operating range; the hardware tolerates 32V, with the clamp and the LM74800 cut-off setting that ceiling under the MPQ4242's 36V VIN limit) and high-current power return; fused again on the blade. Parallel opposed pair placement minimizes inductive loop area (EMI reduction). Total 6-pin continuous capacity: ~6.6A; worst-case draw ~5.3A at 100W from the 20V floor. |
| **A3** | **VIN** | **PGND** | **B3** |  |
| **A4** | **VIN** | **PGND** | **B4** |  |
| **A5** | **VIN** | **PGND** | **B5** |  |
| **A6** | **VIN** | **PGND** | **B6** |  |
